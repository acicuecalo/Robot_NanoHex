...
int myTelemetryIDPacket = 2;
int myTelemetryChecksum = myTelemetryIDPacket + myHeader;
...
void getReadings() {  // Variables to be sent
  ...
  outgoingToESPNOW.idPacket = myTelemetryIDPacket;
  outgoingToESPNOW.checksum = myTelemetryChecksum;
  outgoingToESPNOW.timeStamp = millis();

  outgoingToESPNOW.channel[0] = adcBateria;
  outgoingToESPNOW.channel[1] = mvBateria;
  outgoingToESPNOW.channel[2] = porcentajeBateria;
  */
